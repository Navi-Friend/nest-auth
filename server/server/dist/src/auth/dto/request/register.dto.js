...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Ivan', maxLength: 50 }),
    (0, class_validator_1.IsString)({ message: 'Name must be a string' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Name is required' }),
    (0, class_validator_1.MaxLength)(50, { message: "Name shouldn't be more than 50 chars" }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '123njkljbASf', minLength: 6, maxLength: 128 }),
